...
public class Artist_List extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        parent = v.findViewById(R.id.artist_list_layout);
        createArtistLayout();

        return v;
    }

    private void createArtistLayout() {
        ...
        for (int i = 3; i <= 30; i+=3) {
            ...
            cube1layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    getParentFragmentManager().beginTransaction().replace(R.id.TheList, track_list).addToBackStack(null).commit();
                }
            });

            TextView cube1text = new TextView(getContext());
            cube1text.setText("אמן");
