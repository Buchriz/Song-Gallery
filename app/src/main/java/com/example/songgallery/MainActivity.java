    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        switch (selectedItem) {
            case "artist":
                ...
                getSupportFragmentManager().beginTransaction().replace(R.id.artist_list, artist_list).addToBackStack(null).commit();

                break;
            case "album":
                Album_List album_list = new Album_List();
                getSupportFragmentManager().beginTransaction().replace(R.id.album_list, album_list).addToBackStack(null).commit();
                break;
            case "track":
